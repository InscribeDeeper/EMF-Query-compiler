...
MFVector = defaultdict(lambda: {'cust':'', 'prod':'', 'x_count_quant':0, 'x_sum_quant':0.0, 'x_avg_quant':0.0, 'y_count_quant':0, 'y_sum_quant':0.0, 'y_avg_quant':0.0})
MF_idx=0
MFMap = {}
...
# Outputing
print('='*100)
print('{:<6}|{:>15}|{:>15}|{:>15}|{:>15}|'.format('index','cust','prod','x_avg_quant','y_avg_quant'))
print('='*100)
# Having
output_idx=0
for index in range(len(MFVector)):
	if MFVector[index]['y_avg_quant']!=0 and MFVector[index]['y_avg_quant']>MFVector[index]['x_avg_quant']:
		output_idx+=1
